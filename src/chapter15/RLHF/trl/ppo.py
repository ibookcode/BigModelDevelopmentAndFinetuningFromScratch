...
class PPOTrainer:
    ...
    def __init__(self, model, ref_model, tokenizer, **ppo_params):
        ...
        self.optimizer = torch.optim.AdamW(model.parameters(), lr=self.ppo_params['lr'])
    ...
    def batched_forward_pass(self, queries, responses):
        ...
        for i in range(int(bs/fbs)):
            ...
            with torch.no_grad():
                logits, v = self.model(input_ids)                                    # logits -> (batch, max_output_len, vocab_size); v -> (batch, max_ouput_len)
